...
const Navbar = () => {
  return (
    <nav className="flex flex-row justify-between items-center w-full mt-3 border-b pb-4 sm:px-2 px-1 border-gray-700 gap-2">
      ...
      <div className="flex space-x-4 cursor-pointer text-red-500 rounded-xl p-1 border-solid border border-red-700 hover:bg-red-500 hover:text-white transition duration-300 ease-in-out">
        Sign In / Register
      </div>
    </nav>
  );
